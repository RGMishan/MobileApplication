...
public class ma_list extends AppCompatActivity {
    ...
    public void addOnclickListner(){
        ...
        imageView4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent previous=new Intent(ma_list.this,order.class);
            ...
            public void onClick(View v) {
                ...
                if(date1.isChecked()) {
                    ...
                    if(date2.isChecked()) {
                        ...
                        Intent order=new Intent(ma_list.this, com.example.lab4.order.class);
